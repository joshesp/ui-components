...
`;const N=`<button class="btn-bg-hover-animate">
    <span>Hover me</span>
  ...
  transition: transform 0.25s cubic-bezier(0, 0, 0.5, 1), width 0.25s 0.25s cubic-bezier(0, 0, 0.5, 2);
    ...
    <div class="ui__component">
        <div class="ui__component__preview">
            ...
            <div class="ui__component__example">${N}</div>
        </div>
        <div class="ui__component__code">
            ...
            <pre class="language-html"><code>${y.highlight(N,y.languages.html,"html")}</code></pre>
            <p>Base style.</p>
...
`,ce=`
    ...
    <div class="hr"></div>
    ${ue}
`,K=[{label:"Buttons",component:ce},{label:"Inputs",component:null},{label:"Loaders",component:null},{label:"Progress",component:null},{label:"Text",component:null}],ge=()=>K.map(({label:_})=>`
      <div class="ui__item" id="ui-${_.toLowerCase()}">
        <span>${_}</span>
      </div>
...
`;document.querySelectorAll(".ui__item").forEach(_=>{_.addEventListener("click",S=>{var u;const i=_.getAttribute("id").replace("ui-",""),g=K.find(({label:d})=>d.toLowerCase()===i);document.querySelector(".ui__container__components").innerHTML=`${(u=g==null?void 0:g.component)!=null?u:i}`})});
